...
const loadData = async () => {
  loading.value = true;
  try {
    const res = await axios.get('https://port-0-absol-mk2l6v1wd9132c30.sel3.cloudtype.app/api/repairs');
...
const updateRepair = async (repair, mode, value) => {
  try {
    ...
    await axios.patch(`https://port-0-absol-mk2l6v1wd9132c30.sel3.cloudtype.app/api/repairs/${repair.repair_id}/status`, payload);
