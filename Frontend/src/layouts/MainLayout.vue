  ...
  <q-item-section>로그아웃</q-item-section>
    ...
    <q-footer v-if="isLoggedIn" class="bg-grey-9 q-pa-md">
      <div class="text-center">
        ...
        <div class="text-caption text-grey-5">상호명 : 앱솔텍 | 대표자명 : 이용관 |  유선 번호 : 010-9857-7531</div>
         <div class="text-caption text-grey-5">사업장 주소 :  서울특별시 강남구 개포로 310, 154동 605호(개포동, 다에이치퍼스티어아이파크)</div>
